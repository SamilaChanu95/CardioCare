 ...
 */
final class Version20200506014535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultant ADD c_status VARCHAR(255) NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE nurse ADD n_status VARCHAR(255) NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE technician ADD t_status VARCHAR(255) NOT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultant DROP c_status, CHANGE photo photo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE nurse DROP n_status, CHANGE photo photo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE surgery CHANGE doctor_fassistant_id doctor_fassistant_id INT DEFAULT NULL, CHANGE doctor_sassistant_id doctor_sassistant_id INT DEFAULT NULL, CHANGE doctor_anesthetist_id doctor_anesthetist_id INT DEFAULT NULL, CHANGE nurse_fassistant_id nurse_fassistant_id INT DEFAULT NULL, CHANGE nurse_sassistant_id nurse_sassistant_id INT DEFAULT NULL, CHANGE nurse_tassistant_id nurse_tassistant_id INT DEFAULT NULL, CHANGE consultant_assistant_id consultant_assistant_id INT DEFAULT NULL, CHANGE technician_assistant_id technician_assistant_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE technician DROP t_status, CHANGE photo photo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE unit CHANGE department_id department_id INT DEFAULT NULL');
