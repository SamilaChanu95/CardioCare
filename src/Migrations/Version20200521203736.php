 ...
 */
final class Version20200521203736 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nurse ADD CONSTRAINT FK_D27E6D4363DBB69 FOREIGN KEY (hospital_id) REFERENCES hospital (id)');
        $this->addSql('CREATE INDEX IDX_D27E6D4363DBB69 ON nurse (hospital_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE nurse DROP FOREIGN KEY FK_D27E6D4363DBB69');
        $this->addSql('DROP INDEX IDX_D27E6D4363DBB69 ON nurse');
