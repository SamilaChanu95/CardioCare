 ...
 */
final class Version20200427091413 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultant ADD ward_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE consultant ADD CONSTRAINT FK_441282A1D95D22FD FOREIGN KEY (ward_id) REFERENCES ward (id)');
        $this->addSql('CREATE INDEX IDX_441282A1D95D22FD ON consultant (ward_id)');
        ...
        $this->addSql('ALTER TABLE patient CHANGE p_medical_histroy p_medical_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_allergic_histroy p_allergic_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_surgical_histroy p_surgical_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_drug_histroy p_drug_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_social_histroy p_social_histroy VARCHAR(255) DEFAULT NULL, CHANGE p_surgery_info p_surgery_info TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultant DROP FOREIGN KEY FK_441282A1D95D22FD');
        $this->addSql('DROP INDEX IDX_441282A1D95D22FD ON consultant');
        $this->addSql('ALTER TABLE consultant DROP ward_id');
