 ...
 */
final class Version20200430141221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultant ADD photo VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE nurse ADD photo VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE technician ADD photo VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE consultant DROP photo');
        ...
        $this->addSql('ALTER TABLE nurse DROP photo');
        ...
        $this->addSql('ALTER TABLE technician DROP photo');
