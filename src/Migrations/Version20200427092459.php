 ...
 */
final class Version20200427092459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE technician ADD ward_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE technician ADD CONSTRAINT FK_F244E948D95D22FD FOREIGN KEY (ward_id) REFERENCES ward (id)');
        $this->addSql('CREATE INDEX IDX_F244E948D95D22FD ON technician (ward_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE technician DROP FOREIGN KEY FK_F244E948D95D22FD');
        $this->addSql('DROP INDEX IDX_F244E948D95D22FD ON technician');
        $this->addSql('ALTER TABLE technician DROP ward_id');
